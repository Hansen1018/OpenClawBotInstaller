...
# ║                                                                           ║
# ║   GitHub: https://github.com/Hansen1018/OpenClawBotInstaller                 ║
...
MIN_NODE_VERSION=22
GITHUB_REPO="Hansen1018/OpenClawBotInstaller"
...
print_banner() {
    ...
    cat << 'EOF'
     ...
     OOOOO  PPPPP  EEEEE  NNNNN  CCCCC L     AAAAA W     W
     O   O  P   P  E      N   N  C      L     A     W     W
     O   O  PPPPP  EEEE   N N N  C      L     AAAAA W W W W
     O   O  P      E      N  NN  C      L     A     W W W W
     OOOOO  P      EEEEE  N   N  CCCCC LLLLL A     W  W  W
...
print_success() {
    ...
    echo ""
    echo -e "${PURPLE}📚 官方文档: https://openclaw.ai/docs${NC}"
